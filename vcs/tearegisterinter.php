...
if(isset($_POST['btn-signup']))
{
 ...
 $capture_field_vals ="";
	...
	{$sems=explode(",",$capture_field_vals);
$batchs=explode(",",$capture_field_vals1);
$subsec=explode(",",$capture_field_vals2);
$contc=sizeof($sems);
for($i=0;$i<$contc-1;$i++)
{$class1[$i]=$sems[$i].$batchs[$i];
$subsec1[$i]=$subsec[$i];
mysql_query("INSERT INTO subindex(class,sub,tname) VALUES('$class1[$i]','$subsec[$i]','$name')");
}
