...
<div id="header">
	<div id="left">
    <label><center>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspCEC VIRTUAL CLASSROOM</center></label>
    </div>
    <div id="right">
    	<div id="content">
...
$res1=mysql_query("SELECT * FROM parent WHERE admno='$admno'");
	$sttable=mysql_fetch_array($res1);


	if($sttable['password']==md5($upass))
	{
		$_SESSION['puser'] = $sttable['pname'];
		$_SESSION['pid']=$admno;
...
<tr>
<td><input type="text" name="admno" placeholder="Student Admission Number" required /></td>
</tr>
<tr>
...
<tr>
<td><a href="preg.php">Sign Up Here</a></td>
</tr>
</table>
</form>
</div>
