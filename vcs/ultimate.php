...
ob_end_flush();
	...
	mysql_query("UPDATE $atable SET TOTAL='$sum[$v]' WHERE si='$v'");
$tab=$_SESSION['tableh'];
	// ENTHELUM PATTIYAL CNW MAATANAM EE CODE UNCOMMENT
//$att[$v]+=$sum[$v];
...
<input type="checkbox" name="vehiclet<?php echo htmlspecialchars($j); ?>[]" value="1" <?php  if($x1[$j][$k]==1) echo "checked='checked'";?>/>
<?php }
...
<input type="checkbox" name="vehiclew<?php echo htmlspecialchars($j); ?>[]" value="1" <?php if($x2[$j][$k]==1) echo "checked='checked'"; ?>/>
<?php }
...
<input type="checkbox" name="vehicleh<?php echo htmlspecialchars($j); ?>[]" value="1" <?php if($x3[$j][$k]==1) echo "checked='checked'"; ?>/>
<?php }
...
<input type="checkbox" name="vehiclef<?php echo htmlspecialchars($j); ?>[]" value="1" <?php if($x4[$j][$k]==1) echo "checked='checked'"; ?>/>
<?php }
